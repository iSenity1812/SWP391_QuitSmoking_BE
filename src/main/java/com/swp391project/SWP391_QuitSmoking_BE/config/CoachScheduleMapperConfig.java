...
public class CoachScheduleMapperConfig {
        ...
        public void configure() {
                ...
                modelMapper.createTypeMap(Coach.class, CoachSimpleResponseDTO.class)
                                .addMapping(src -> src.getUser().getUserId(), CoachSimpleResponseDTO::setCoachId) // CoachId
                                                                                                                  // lấy
                                                                                                                  // từ
                                                                                                                  // User
                ...
                modelMapper.createTypeMap(CoachSchedule.class, CoachScheduleResponseDTO.class)
                                .addMapping(CoachSchedule::getScheduleId, CoachScheduleResponseDTO::setScheduleId) // Ví
                                                                                                                   // dụ:
                                                                                                                   // nếu
                                                                                                                   // tên
                                                                                                                   // không
                                                                                                                   // khớp
                                .addMapping(CoachSchedule::isBooked, CoachScheduleResponseDTO::setBooked) // Nếu getter
                                                                                                          // là
                                                                                                          // isBooked()
                                                                                                          // và setter
                                                                                                          // là
                ...
                // .addMapping(CoachSchedule::getCreatedAt,
                // CoachScheduleResponseDTO::setCreatedAt)
                // .addMapping(CoachSchedule::getUpdatedAt,
                // CoachScheduleResponseDTO::setUpdatedAt);

                // Các trường khác như timeSlot cũng sẽ được ánh xạ tự động nếu có TypeMap
