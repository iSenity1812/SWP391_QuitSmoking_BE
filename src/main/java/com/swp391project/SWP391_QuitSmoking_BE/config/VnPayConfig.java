...
public class VnPayConfig {
    ...
    // CÁC TRƯỜNG STATIC NÀY CÓ THỂ LÀ NGUYÊN NHÂN GÂY RẮC RỐI VÌ NÓ KHÔNG PHẢI LÀ
    // SPRING BEAN PROPERTY
    // NẾU BẠN KHÔNG SỬ DỤNG CÁC TRƯỜNG STATIC NÀY ĐỂ TRUY CẬP CẤU HÌNH Ở BẤT KỲ ĐÂU
    // NGOÀI VnPayConfig,
    // BẠN CÓ THỂ CÂN NHẮC XÓA CHÚNG ĐỂ ĐƠN GIẢN HÓA VÀ TRÁNH NHẦM LẪN.
    // Nếu có sử dụng, hãy chắc chắn rằng bạn truy cập chúng SAU khi @PostConstruct
    // được gọi.
