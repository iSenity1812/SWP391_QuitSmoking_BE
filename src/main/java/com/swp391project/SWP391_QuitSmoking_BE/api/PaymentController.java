...
public class PaymentController {
    ...
    public ResponseEntity<Map<String, Object>> createVnPayPayment(@RequestBody VnPayRequest request,
    ...
    private String generateSuccessHtml(String transactionRef) {
        return "<!DOCTYPE html>" +
                ...
                "        <p class='info'>Mã giao dịch: <strong>" + (transactionRef != null ? transactionRef : "N/A")
                + "</strong></p>" +
