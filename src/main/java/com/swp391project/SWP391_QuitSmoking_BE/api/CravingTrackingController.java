...
//    @PreAuthorize("hasRole('NORMAL_MEMBER') or hasRole('PREMIUM_MEMBER')")
//    public ResponseEntity<List<CravingTrackingResponse>> getCravingTrackingsByDailySummaryId(
//            @AuthenticationPrincipal UserDetails userDetails, @PathVariable Integer dailySummaryId) {
//        UUID memberId = userService.getUserIdFromUserDetails(userDetails);
//        List<CravingTrackingResponse> response = cravingTrackingService.getCravingTrackingsByDailySummaryId(dailySummaryId);
