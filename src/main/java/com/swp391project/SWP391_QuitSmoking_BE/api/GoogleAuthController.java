...
public class GoogleAuthController {
     ...
     */
    @PostMapping("/link")
    public ResponseEntity<AuthResponse> linkGoogleAccount(@RequestBody GoogleAuthRequest request) {
        try {
            AuthResponse response = googleAuthService.linkGoogleAccount(request.getGoogleId());
            return ResponseEntity.ok(response);
        } catch (Exception e) {
            return ResponseEntity.badRequest()
                    .body(AuthResponse.builder()
    ...
    public ResponseEntity<AuthResponse> unlinkGoogleAccount() {
        try {
            AuthResponse response = googleAuthService.unlinkGoogleAccount();
            return ResponseEntity.ok(response);
        } catch (Exception e) {
            return ResponseEntity.badRequest()
                    .body(AuthResponse.builder()
