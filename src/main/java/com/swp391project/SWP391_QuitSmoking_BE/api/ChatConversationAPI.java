...
// import com.swp391project.SWP391_QuitSmoking_BE.entity.User; // Có thể bỏ nếu không dùng User entity trực tiếp ở đây
...
public class ChatConversationAPI {
    ...
    public List<ChatConversation> getConversationsByUser(@PathVariable UUID userId) {
        ...
        // chúng ta chỉ cần kiểm tra xem UserProfile có tồn tại không và sử dụng userId của nó.
