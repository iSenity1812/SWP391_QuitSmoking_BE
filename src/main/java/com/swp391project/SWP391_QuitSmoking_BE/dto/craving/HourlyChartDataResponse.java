...
public class HourlyChartDataResponse {
    ...
    private Integer smokedCount; // Tổng số điếu thuốc đã hút trong giờ đó
    private Integer cravingCount; // Tổng số lần thèm thuốc trong giờ đó
    ...
    public HourlyChartDataResponse(int hour, Integer smokedCount, Integer cravingCount) {
        this.hour = hour;
