...
public class PaymentService {
    ...
    public PaymentOrderResponse createOrder(PaymentOrderRequest request, String clientIP) {
        ...
        try {
            ...
            // DÒNG NÀY SẼ GỌI CONSTRUCTOR KHÔNG THAM SỐ ĐƯỢC TẠO BỞI LOMBOK @NoArgsConstructor
            // Đảm bảo không có constructor thủ công nào khác trong PaymentOrderResponse.java
            PaymentOrderResponse response = new PaymentOrderResponse(); // <--- ĐÂY LÀ DÒNG GÂY LỖI NẾU KHÔNG CÓ CONSTRUCTOR RỖNG
    ...
    private void processSuccessfulPayment(Transaction transaction, Map<String, String> fields) {
        try {
            ...
            logger.info("Created new MemberSubscription for member: {} with ID: {}", member.getMemberId(), newMemberSubscription.getMemberSubscriptionId());
